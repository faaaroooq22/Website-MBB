...
const Hero: React.FC<{ onOrderClick: () => void }> = ({ onOrderClick }) => {
    return (
        <header id="home" className="relative w-full min-h-[100dvh] flex items-center justify-center pt-16 md:pt-24 pb-4 md:pb-12 overflow-hidden bg-white border-b border-neutral-100">
            ...
            <div className="container mx-auto px-2 md:px-4 relative z-10 flex flex-col items-center justify-center text-center">
                <div className="max-w-5xl space-y-3 md:space-y-6 reveal active">
                    <div className="font-kalma text-3xl md:text-4xl text-gray-900 kalma-text mb-1 md:mb-6">
                        لا اله الا الله محمد رسول الله
                    </div>
                    <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full bg-red-600 text-white font-black tracking-[0.2em] text-[10px] md:text-xs mb-1 md:mb-2 shadow-[0_10px_30px_rgba(220,38,38,0.3)] uppercase">
                    ...
                    <div className="pt-2 md:pt-4 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
            ...
            {/* Scroll Indicator */}
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 opacity-30 animate-bounce hidden md:flex">
                <div className="w-0.5 h-8 bg-gradient-to-b from-red-500 to-transparent"></div>
            </div>
        </header>
    );
};
        ...
        <section id="reviews" className="py-24 bg-neutral-50 relative overflow-hidden">
            <div className="container mx-auto px-4 max-w-4xl text-center reveal active">
                <div className="mb-10" dir="rtl">
                    <div className="text-3xl md:text-5xl font-extrabold text-gray-900 opacity-90 tracking-widest leading-loose">
                        وَتُعِزُّ مَن تَشَاءُ وَتُذِلُّ مَن تَشَاءُ
                    </div>
                    <div className="text-sm md:text-base text-gray-500 font-medium mt-2 tracking-wide opacity-80" dir="ltr">
                        (Al Quran - 3:26)
                    </div>
                </div>
  ...
  return (
    <section id="location" className="py-24 bg-white relative border-t border-neutral-100">
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        ...
        <div className="rounded-3xl overflow-hidden border-8 border-neutral-50 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] reveal active h-[500px] md:h-[600px] bg-white relative">
          <iframe 
